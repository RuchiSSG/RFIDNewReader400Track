...
//            _tcpListenerService.SetParameters(
//                accessToken, userid, recruitid, deviceId,
//                location, eventName, eventId, ipaddress, sessionid
//            );
    ...
    accessToken, userid, recruitid, sesionid, ipaddress);
        ...
        public async Task<IActionResult> SubmitButton([FromBody] DeviceConfigurationDto formData)
        {
            try
            {
                ...
                Response.Cookies.Append("CategoryId", formData.categoryId);
        ...
        public async Task<IActionResult> GetChestRFIDByGroup(int groupId)
        {
         ...
         result.Select(x => x.TagId), isActive: false  // ✅ Race start hone tak filter inactive rahega
     );
